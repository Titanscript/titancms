    ...
    <div class="row">
        ...
        <div class="col-md-9 order-md-2">
            <div class="g-pl-15--lg">
                <!-- Banner -->
                <div class="g-bg-size-cover g-bg-pos-center g-mt-30 g-py-40" style="background-image: url(https://picsum.photos/900/450?grayscale&blur=3);">
                    <div class="g-pos-rel g-z-index-1 g-pa-50">
                        <span class="d-block g-color-primary g-font-weight-700 g-font-size-20 mb-0"><?= $category->description ?></span>
                        <h2 class="g-color-white g-font-size-50 mb-3"><?= $category->name ?></h2>
                    </div>
                </div>
                <!-- End Banner -->
