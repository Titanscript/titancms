...
class ProductAttributesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_attribute_header_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_product_attributes_product_attribute_headers1_idx' => ['type' => 'index', 'columns' => ['product_attribute_header_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_product_attributes_product_attribute_headers1' => ['type' => 'foreign', 'columns' => ['product_attribute_header_id'], 'references' => ['product_attribute_headers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
