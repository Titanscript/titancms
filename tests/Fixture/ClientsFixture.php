...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_clients_medias1_idx' => ['type' => 'index', 'columns' => ['media_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_clients_medias1' => ['type' => 'foreign', 'columns' => ['media_id'], 'references' => ['medias', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-04-03 12:10:41',
                'modified' => '2020-04-03 12:10:41',
                'media_id' => '76b3f3e2-a9e0-48b1-8c7f-d4b5505982e3',
            ],
        ];
        parent::init();
    }
