...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?= $this->Form->control('new_password', ['class' => 'form-control', 'type' => 'password', 'label' => __('รหัสผ่าน')]) ?>
        <?= $this->Form->control('confirm_password', ['class' => 'form-control', 'type' => 'password', 'label' => __('ยืนยันรหัสผ่าน')]) ?>
